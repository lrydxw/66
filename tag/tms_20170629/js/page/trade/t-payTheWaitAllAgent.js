$(function(){
    ...
    var tradeFun = transfar.Base.extend({
        ...
        events: {
            ...
            "click .look-btn-cancel":"ordercancel", //取消支付
            ...
            "click #searchPayOffline":"offline"//线下支付
        ...
        getData:function(page){
            ...
            var url=apiUrl.agentSelectDispatchBatchOrderList;
            //获取列表
            getJsonp({
                url:url,
                data:searchData,
                callback:function(d){
                    ...
                    template.helper('driver',function(data,type){
                        var str=''
                        str=data.memo.split(",").join(" ")
                        return str;
                    })
        ...
        ordercancel:function(e){
            ...
            getJsonp({
                url:apiUrl.agentDeleteDispatchBatchOrder,
                data:{
        ...
        orderinfo:function(e){
            ...
            getJsonp({
                url:apiUrl.selectDispatchShipBillList,
                data:searchData,
                callback:function(d){
                    if(d.result=="error"){
                        alertMsg(d.msg);
        ...
        offline:function(){
            var _this=this;
             ...
             if(this.allcheck.length<1){
                ...
                this.isok=false
                getJsonp({
                    url:apiUrl.agentPayDispatchBatchOrdersOffline,
                    data:{
