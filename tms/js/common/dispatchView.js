...
apiServer.agent = com2_server + "/dispatchView/agent";//承运商列表
apiServer.owner = com2_server + "/dispatchView/owner";//承运商列表
...
//承运商
apiUrl.agentSelectDispatchOrderList = apiServer.agent + "/dispatchOrder/selectDispatchOrderList";//承运商订单列表
apiUrl.agentSelectDispatchOrderDetail = apiServer.agent + "/dispatchOrder/selectDispatchOrderDetail";//承运商订单详情
apiUrl.selectDispatchDriverList = apiServer.agent + "/dispatchDriver/selectDispatchDriverList";//承运商车队
...
/*新增承运商接口*/
apiUrl.startLocation=apiServer.agent +"/dispatchDriver/startLocation";//开始定位已选司机
apiUrl.isDredgeLocation=apiServer.agent +"/dispatchDriver/isDredgeLocation";//司机开通定位的接口
apiUrl.location=apiServer.agent +"/dispatchDriver/location";//司机定位的接口（司机会员id）
apiUrl.saveVoucher=apiServer.agent +"/dispatchVoucher/saveVoucher";//未开票订单上传开票信息
apiUrl.selectDispatchVoucherDetail=apiServer.agent +"/dispatchVoucher/selectDispatchVoucherDetail";//已开票订单查询发票详情
apiUrl.selectSummaryOrder=apiServer.agent +"/dispatchStatement/selectSummaryOrder";//订单汇总表
apiUrl.selectSummaryOrderfee=apiServer.agent +"/dispatchStatement/selectSummaryOrderfee";//财务汇总表
apiUrl.selectOrder=apiServer.agent +"/dispatchStatement/selectOrder";//订单报表
apiUrl.selectShipBill=apiServer.agent +"/dispatchStatement/selectShipBill";//司机运费报表
apiUrl.exportDispatchStatement=apiServer.agent +"/dispatchStatement/exportDispatchStatement";//导出报表
...
//货主新增接口
apiUrl.ownerSelectSummaryOrder=apiServer.owner+"/dispatchStatement/selectSummaryOrder"//订单汇总表
apiUrl.ownerSelectOrderfeeSum=apiServer.owner+"/dispatchStatement/selectOrderfeeSum"//订单报表总计
apiUrl.ownerSelectOrderfee=apiServer.owner+"/dispatchStatement/selectOrderfee"//订单报表，运费支付报表
apiUrl.ownerSelectSummaryOrderfee=apiServer.owner+"/dispatchStatement/selectSummaryOrderfee"//财务汇总表
apiUrl.ownerSelectOrder=apiServer.owner+"/dispatchStatement/selectOrder"//承运商运费报表
apiUrl.ownerExportDispatchStatement=apiServer.owner+"/dispatchStatement/exportDispatchStatement"//导出报表
