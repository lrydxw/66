...
apiUrl.getLoginMsg =com_server + "/tradeView/logincs/getLoginMsg"; //获取登录信息
apiUrl.logoutWeb = PASSPORT + "/passport/logoutWeb?skipCode=tradeview"; //登出 删除cookie
var commonMsg = {};
...
var menufun = transfar.Base.extend({
	...
	initialize: function () {
		...
		//agent==承运商(FBA) owner==货主 contractor==代理(总包商)
		this.menudata = {
			//'list': [],
			'list1': [{
				title: "订单管理",
				...
				list: [{
					...
					title: "派车单列表",
					url: '../order/carOrder.html?type=carOrderAgent'
				}, {
					title: "完成订单",
				...
				list: [{
					title: "未开票订单",
					url: '../ticket/unTicket.html?type=unticket'
				},{
					title: "已开票订单",
					url: '../ticket/ticket.html?type=ticket'
				}]
			}, {
				title: "运力管理",
				url: "#",
				...
				list: [{
					title: "订单汇总表",
					url: '../report/sumTable.html?type=agentOrder'
				}, {
					title: "订单报表",
					url: '../report/reportTable.html?type=agentReport'
				}, {
					title: "财务汇总表",
					url: '../report/sumTable.html?type=agentMoney'
				}, {
					title: "司机运费报表",
					url: '../report/driverFreight.html'
				}]
			}
			...
			// ]},
			{
				...
				list: [{
					title: "订单汇总表",
					url: '../report/sumTable.html?type=ownerOrder'
				}, {
					title: "订单报表",
					url: '../report/reportTable.html?type=ownerReport'
				}, {
					title: "财务汇总表",
					url: '../report/sumTable.html?type=ownerMoney'
				}, {
					title: "运费支付报表",
					url: '../report/reportTable.html?type=freightReport'
				}, {
					title: "承运商运费报表",
					url: '../report/agentFreight.html'
				}]
			}
			...
			}, 
			{
				...
				list: [{
					...
					title: "已转运订单",
					url: '../order/packageOrder.html?type=sendOrder'
				}]
			}, {
				title: "运力管理",
				url: "#",
		...
		this.data = {
			list: [{
				...
				list: [{
		        	...
		        	{title:"登录帮助",url:lujing56_server + '/view/help/g-loginHelp.html'}]
			}, {
				title: "陆鲸货主",
				url: "#",
				list: [{
