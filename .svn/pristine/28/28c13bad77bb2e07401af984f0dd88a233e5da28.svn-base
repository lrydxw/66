...
$(function(){
    ...
    var tradeFun = transfar.Base.extend({
        ...
        checkfor:function(e){
            ...
            var $this=$(e.currentTarget);
            var id=$this.attr('data-dispatchorderid')
            var money=$this.attr('data-amount')
            var param={}
            var html=
                '<div >' +
                    ...
                    '<div class="input-line" >' +
                        ...
                        '<input type="text" class="t-c-input input-width2"  id="Amount2"  require="true"  name="goodsname" maxlength="30"/>'+
                    '</div>'+
                    '<div class="input-line" >' +
                        '<span class="input-title" style="width:120px;">变更后金额:(元)</span>'+
                        '<input type="text" class="t-c-input input-width2"  id="Amount3"  require="true"  name="goodsname" maxlength="30" disabled/>'+
                    '</div>'+
